    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (mFixAspectRatio) {
            ...
            if (horizontalPadding > verticalPadding) {
                ...
                float y_width = Math.abs(Math.abs(bitmapRect.bottom - bitmapRect.top) - 2 * padding);
                Edge.LEFT.setCoordinate((bitmapRect.left + bitmapRect.right) / 2.0f - y_width / 2.0f);
                Edge.TOP.setCoordinate(bitmapRect.top + padding);
                Edge.RIGHT.setCoordinate((bitmapRect.left + bitmapRect.right) / 2.0f + y_width / 2.0f);
                Edge.BOTTOM.setCoordinate(bitmapRect.bottom - padding);
            } else {
                padding = horizontalPadding;
                float x_width = Math.abs(Math.abs(bitmapRect.right - bitmapRect.left) - 2 * padding);
                Edge.LEFT.setCoordinate(bitmapRect.left + padding);
                Edge.TOP.setCoordinate((bitmapRect.top + bitmapRect.bottom) / 2.0f - x_width / 2.0f);
                Edge.RIGHT.setCoordinate(bitmapRect.right - padding);
                Edge.BOTTOM.setCoordinate((bitmapRect.top + bitmapRect.bottom) / 2.0f + x_width / 2.0f);
            }
        }
    }
