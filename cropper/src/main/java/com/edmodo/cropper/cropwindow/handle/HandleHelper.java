...
abstract class HandleHelper {
    ...
    void updateCropWindow(float x,
        ...
        if(!CropImageView.isCropImgTypeSqu())
            return;



        if(primaryEdge == Edge.BOTTOM && secondaryEdge == Edge.RIGHT) {
            if (Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate() > Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate()) {
                float dis = Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate();
                if(Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate() +  Edge.LEFT.getCoordinate() > imageRect.right ) {
                    dis = imageRect.right - Edge.LEFT.getCoordinate();
                }
                primaryEdge.setCoordinate(dis + Edge.TOP.getCoordinate());
                secondaryEdge.setCoordinate(dis + Edge.LEFT.getCoordinate());
            }
            else
            {
                float dis = Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate();
                if(Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate() +  Edge.TOP.getCoordinate() > imageRect.bottom ) {
                    dis = imageRect.bottom - Edge.TOP.getCoordinate();
                }
                primaryEdge.setCoordinate(dis + Edge.TOP.getCoordinate());
                secondaryEdge.setCoordinate(dis + Edge.LEFT.getCoordinate());
            }
        }
        else if(primaryEdge == Edge.TOP && secondaryEdge == Edge.RIGHT) {
            if (Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate() > Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate()) {
                float dis = Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate();
                if(Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate() +  Edge.LEFT.getCoordinate() > imageRect.right ) {
                    dis = imageRect.right - Edge.LEFT.getCoordinate();
                }
                primaryEdge.setCoordinate(Edge.BOTTOM.getCoordinate() - dis);
                secondaryEdge.setCoordinate(dis + Edge.LEFT.getCoordinate());
            }
            else
            {
                float dis = Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate();
                if( Edge.BOTTOM.getCoordinate() - (Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate())  < imageRect.top ) {
                    dis = Edge.BOTTOM.getCoordinate() -  imageRect.top;
                }
                primaryEdge.setCoordinate( Edge.BOTTOM.getCoordinate() - dis);
                secondaryEdge.setCoordinate(dis + Edge.LEFT.getCoordinate());
            }
        }  else if(primaryEdge == Edge.TOP && secondaryEdge == Edge.LEFT) {
            if (Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate() > Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate()) {
                float dis = Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate();
                if( Edge.RIGHT.getCoordinate() - (Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate()) < imageRect.left ) {
                    dis = Edge.RIGHT.getCoordinate() - imageRect.left;
                }
                primaryEdge.setCoordinate(Edge.BOTTOM.getCoordinate() - dis);
                secondaryEdge.setCoordinate( Edge.RIGHT.getCoordinate() - dis);
            }
            else
            {
                float dis = Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate();
        ...
        } else  if(primaryEdge == Edge.BOTTOM && secondaryEdge == Edge.LEFT) {
            if (Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate() > Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate()) {
                float dis = Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate();
                if( Edge.RIGHT.getCoordinate() - (Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate())  < imageRect.left ) {
                    dis = imageRect.right - Edge.LEFT.getCoordinate();
